...
\begin{frame}{History}
  \begin{tikzpicture}
    \graph [
      ...
      "v1.2" [green!60!black, x=4],
      a <- b <- c <- d <- {e <- f, g [x=0.5]} <- h <- {i <- master [vertexDarkRed], j <- foo [vertexDarkRed]};
      "v1.2" -> e;
    };
  \end{tikzpicture}
...
\begin{frame}{Hoster}
  \begin{columns}[t]
    \begin{column}{0.3\textwidth}
      \href{https://github.com}{\includegraphics[width=\linewidth]{figures/github.png}}
      \begin{itemize}
        \item größter Hoster
    ...
    \end{column}
    \begin{column}{0.3\textwidth}
      \href{https://bitbucket.org}{\includegraphics[width=\linewidth]{figures/bitbucket.png}}
      \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.3\textwidth}
      \href{https://gitlab.com}{\includegraphics[width=\linewidth]{figures/gitlab.png}}
      \begin{itemize}
        \item open-source
