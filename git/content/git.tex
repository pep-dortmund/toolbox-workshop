...
\begin{frame}[c]{Warum also Versionskontrolle nutzen?}
  ...
  \begin{description}[Warum?]
    ...
    \item[Wann?] Wann wurde ein bestimmter Bug einführt bzw. behoben?
  \end{description}
  ...
  \onslide<2>{%
    \begin{center}%
      ...
      für nachvollziehbare, reproduzierbare Wissenschat%
    \end{center}
  }
\end{frame}
...
\begin{frame}{Video-Aufzeichnung}
  Im Rahmen einer Schulung ist 2020 eine Videoaufzeichnung einer ausführlicheren Git-Einführung angefertigt worden, die auf diesem Kurs basiert:
