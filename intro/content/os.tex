...
\begin{frame}{Betriebssysteme}
    ...
    Windows 11 bringt das \emph{Windows Subsystem for Linux} mit, eine integrierte Linux VM.
\end{frame}
...
\begin{frame}{Linux-Distributionen}
    ...
    \begin{itemize}
        ...
        \item Unterschiedliche Distributionen (Arch, Fedora, PopOs, Endeavor, \dots)
