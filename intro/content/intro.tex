...
\begin{frame}{Betriebssystem}
  \centering
  \includegraphics[height=0.89\textheight]{figures/os.pdf}
\end{frame}

\begin{frame}{Programmierkenntnisse}
  \centering
  \includegraphics[height=0.89\textheight]{figures/programming.pdf}
\end{frame}

\begin{frame}{Interessen}
  \centering
  \includegraphics[height=0.89\textheight]{figures/interest.pdf}
\end{frame}
