...
\begin{frame}{Motivation}
  \begin{center}
    ...
    Unsicherheiten bestimmen \hspace{2em} Protokoll verfassen\\
  \end{center}
\end{frame}
    ...
    \begin{itemize}
      ...
      \item Gründe sind vielfältig, aber hauptsächlich
        \begin{itemize}
          ...
          \item Veröffentlichungen mit der vollen Information hinter \enquote{Pay Walls}
          \item ...
        \end{itemize}
...
\begin{frame}[fragile]{Isolierte Umgebungen}
  \begin{itemize}
    ...
    \item conda / mamba ermöglichen es, isoliertie, benannte Umgebungen zur erzeugen mit eigenen Versionen von Python und Bibliotheken
