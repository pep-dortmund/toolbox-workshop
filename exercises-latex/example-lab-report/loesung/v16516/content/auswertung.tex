...
\begin{align}
  ...
  g_\text{K} = \input{parameter-g_ball.tex} && t_{0,\text{K}} = \input{parameter-t0-g_ball.tex}
\intertext{und für den Zylinder}
  \label{eq:parameters-g_cylinder}
  g_\text{Z} = \input{parameter-g_cylinder.tex} && t_{0,\text{Z}} = \input{parameter-t0-g_cylinder.tex}.
\end{align}
...
\begin{align}
  ...
  I_\text{K} &= \input{parameter-I_ball.tex} &t_{0,\text{K}} &= \input{parameter-t0-I_ball.tex}
  \intertext{und für den Zylinder}
  \label{eq:parameters-I_cylinder}
  I_\text{Z} &= \input{parameter-I_cylinder.tex} & t_{0,\text{Z}} &= \input{parameter-t0-I_cylinder.tex}.
\end{align}
