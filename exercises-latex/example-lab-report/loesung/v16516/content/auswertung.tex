...
\begin{align}
  ...
  g_\text{K} = \input{parameter-g_ball.tex} && t_{0,\text{K}} = \input{parameter-t0_ball.tex}
\intertext{und für den Zylinder}
  \label{eq:parameters-g_cylinder}
  g_\text{Z} = \input{parameter-g_cylinder.tex} && t_{0,\text{Z}} = \input{parameter-t0_cylinder.tex}.
\end{align}
