...
\title[Toolbox 2026]{Toolbox Workshop 2026}
\subtitle{Python, Unix, Make, Git, \LaTeX{}}
\date{28.~September – 09.~Oktober 2026}
...
\begin{frame}
  ...
  \begin{center}
    ...
    28.~September – 02.~Oktober 2026, 13 - 17~Uhr\\%,
    Ort: Bio- \& Chemieingenieurwesen CT ZE HS02
  \end{center}
...
\begin{frame}
  \begin{center}
    ...
    05.~Oktober – 08.~Oktober 2026, 13 - 17~Uhr,\\
    Ort: Bio- \& Chemieingenieurwesen CT ZE HS02
  \end{center}
\end{frame}
...
\begin{frame}{Vorbereitung}
  \begin{center}
    ...
    Anmeldung ausfüllen\\
    →~\textcolor{blue!70!black}{\href{https://registration.pep-dortmund.org/events/toolbox26/registration/}{registration.pep-dortmund.org/events/toolbox26/registration}}\\[0.5\baselineskip]
    Software installieren\\
    →~\textcolor{blue!70!black}{\href{https://toolbox.pep-dortmund.org/install/install/}{toolbox.pep-dortmund.org/install/install}}\\[0.5\baselineskip]
...
\begin{frame}{Installation}
  ...
  \begin{itemize}
    ...
    \item Donnerstag 24.09.2026: ab 10:00 Uhr, Ort: CP-03-123
  \end{itemize}
\end{frame}
\begin{frame}
