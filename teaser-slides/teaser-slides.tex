...
\begin{frame}{Installation}
  \huge
  Falls ihr euch für Linux interessiert:\\[0.5\baselineskip]
	\begin{itemize}
...
\begin{frame}{Installation}
  ...
  Falls ihr euch für Linux interessiert:\\[0.5\baselineskip]
	\begin{enumerate}
    \item Unserer \href{https://toolbox.pep-dortmund.org/install/dualboot.html}{Anleitung} folgen.
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Donnerstag 21.09.2023: ab 10:00 Uhr, Ort: tba
  \end{enumerate}
\end{frame}
\begin{frame}
