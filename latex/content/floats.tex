...
\begin{frame}[fragile]{
  ...
  \doc{ftp://ftp.tu-chemnitz.de/pub/tex/macros/latex/contrib/placeins/placeins-doc.pdf}{placeins}
  \doc{http://ftp.uni-erlangen.de/mirrors/CTAN/macros/latex/contrib/caption/caption-deu.pdf}{caption}
}
  \begin{itemize}
