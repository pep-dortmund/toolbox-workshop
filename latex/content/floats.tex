...
\begin{frame}[fragile]{
  ...
  \doc{http://mirrors.ctan.org/macros/latex/contrib/placeins/placeins-doc.pdf}{placeins}
...
\begin{frame}[fragile]{Subfigures\hfill \doc{ftp://ftp.rrzn.uni-hannover.de/pub/mirror/tex-archive/macros/latex/contrib/caption/subcaption.pdf}{subcaption}}
  \begin{Packages}
    \begin{lstlisting}
  ...
  \begin{itemize}
    \item \LaTeX{} hat 4 Regionen, in die es Float-Umgebungen platziert
      \begin{description}
        ...
        \item[\texttt{t}] top, oben auf der Seite
        \item[\texttt{b}] bottom, unten auf der Seite
        \item[\texttt{p}] page, eigene Seite nur für Floats
      \end{description}
    \item Standardmäßig nur \texttt{t,b,p} genutzt.
    \item \alert{Nicht} empfohlen: Änderung mit optionalen Argument an Umgebung.
