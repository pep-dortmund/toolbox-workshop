...
\begin{frame}[fragile]{Unsicherheiten in Tabellen}
  ...
  \begin{block}{Beispiel}
    \begin{minted}{latex}
      \begin{tblr}{
          colspec = {S[table-format=3.1(2.1)]},
          row{1} = {guard, mode=math},
        }
        \toprule
...
\begin{frame}{Resultat}
  ...
  \vspace{5pt}
  \begin{itemize}
    \item Über \mintinline{latex}+table-format+ von siunitx können wir auch das Format der Unsicherheiten angeben
    \item Unsicherheiten werden dann in Klammern \mintinline{latex}+(…)+ hinter die Werte gesetzt
