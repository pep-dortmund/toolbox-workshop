...
\begin{frame}[fragile]{Das Dokument}
  ...
  \begin{columns}[onlytextwidth, t]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tblock}{\lstinline+\\documentclass+}
        Dokumentenklasse=Vorlage wählen, mit Optionen anpassen.
      \end{tblock}
      \begin{tblock}{Präambel}
        Globale Optionen und zusätzliche Pakete.
      \end{tblock}
      \begin{tblock}{\texttt{document}-Umgebung}
        Inhalt des Dokuments.
      \end{tblock}
    \end{column}
  \end{columns}
...
\begin{frame}[fragile]{Standardpakete}
  ...
  \vspace{-1em}
  \begin{CodeExplanation}{0.48}[Paket][Funktion]
    \begin{lstlisting}
      \usepackage{fixltx2e}
...
\begin{frame}[fragile]{
  ...
  \begin{tblock}{Fürs Praktikum empfohlenene Klasse}
    \begin{lstlisting}
...
\begin{frame}[fragile]{Das Ausgabedokument erstellen}
  ...
  \begin{tblock}{\LaTeX-Dokument kompilieren}
    Terminal öffnen:
    \begin{lstlisting}
...
\begin{frame}{\texttt{texdoc}}
  ...
  \begin{tblock}{Dokumentation zu einem Paket}
    \texttt{texdoc \textit{paket}}
  \end{tblock}

  Dabei ist \texttt{\textit{paket}} ein Suchstring.
  \begin{tblock}{Nach Dokumentation suchen}
