...
\begin{frame}[fragile]{Syntax: Befehle}
  ...
  \Explanation
    ...
    Papierformat DIN\,A4 \\[\baselineskip]
    Keine Argumente \\
...
\begin{frame}[fragile]{Syntax: Umgebungen}
  \begin{itemize}
    ...
    \item Diese müssen aber in Umgebung wieder geschlossen werden
\end{itemize}
  \begin{columns}[onlytextwidth, t]
    \begin{column}{0.48\textwidth}
      \begin{block}{Geht:}
...
\begin{frame}[fragile]{Fonteinstellungen}
  ...
  \begin{itemize}
    ...
    \item Bei Änderung auch Mathefont anpassen → später in  \ref{sec:math}
  \end{itemize}
\end{frame}
