...
\begin{frame}[fragile]{
  ...
  \begin{itemize}
    ...
    \item \alert{Das ist i.A. nicht sinnvoll: \IfFontExistsTF{Comic Sans MS}{\fontspec{Comic Sans MS} Hallo Welt in Comic Sans!}{Herzlichen Glückwunsch, diese PDF ist ohne \enquote{Comic Sans} gebaut worden!}}
