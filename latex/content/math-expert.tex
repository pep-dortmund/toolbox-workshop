...
\begin{frame}[fragile]{\mintinline{latex}+\Re+, \mintinline{latex}+\Im+}
...
\begin{frame}[fragile]{Richtiges Spacing für \mintinline{latex}+\left+, \mintinline{latex}+\right+}
  \begin{Packages}
    \begin{minted}{latex}
...
\begin{frame}[fragile]{\mintinline{latex}+\DeclarePairedDelimiter+}
  \begin{itemize}
...
\begin{frame}[fragile]{\mintinline{latex}+\bra, \ket, \braket+}
...
\begin{frame}[fragile]{\mintinline{latex}+\delimitershortfall+}
