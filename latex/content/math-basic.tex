\begin{frame}[fragile]{Pakete}
  \begin{lstverbatim}
  \usepackage{amsmath}      % viele nützliche Mathe-Befehle
  \usepackage{amssymb}      % viele Mathe-Symbole
  \usepackage{mathtools}    % nützliche Befehle
  ...
  \usepackage[
    ...
    nabla=upright,          % |
    partial=upright,        % /
    vargreek-shape=unicode, % Unicode-Standard folgen
  ]{unicode-math}           % "It does exactly what it says on the tin"
  \end{lstverbatim}
\end{frame}
