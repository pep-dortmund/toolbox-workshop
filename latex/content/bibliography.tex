  ...
  \begin{itemize}
    ...
    \item Viele Felder fordern ein bestimmtes Format, z.\,B.\ Autorenlisten, Daten
      \begin{description}[Seitenzahlen]
        \item[Namensliste] \mintinline{latex}+Nachname1, Vorname1 and Nachname2, Vorname2 and others+
        \item[Datum] \mintinline{latex}+YYYY-MM-DD+ (ISO8601)
        \item[Seitenzahlen] \mintinline{latex}+X--Y+
      \end{description}
  \end{itemize}
...
\begin{frame}[fragile]{Anleitungen: \mintinline{latex}+@manual+}
...
\begin{frame}[fragile]{Journal-Artikel: \mintinline{latex}+@article+}
  \begin{block}{Pflichtfelder}
...
\begin{frame}[fragile]{Bücher: \mintinline{latex}+@book+}
  \begin{block}{Pflichtfelder}
    \texttt{author}, \hspace{2em}
    \texttt{title}, \hspace{2em}
    \texttt{year} oder \texttt{date}
...
\begin{frame}[fragile]{Abschlussarbeiten: \mintinline{latex}+@thesis+, \mintinline{latex}+@phdthesis+, \mintinline{latex}+@mastersthesis+}
  \begin{block}{Pflichtfelder}
    \texttt{author}, \hspace{2em}
    \texttt{title}, \hspace{2em}
    \texttt{institution},  \hspace{2em}
    \texttt{year} oder \texttt{date},  \hspace{2em}
    \texttt{type} (nur für \mintinline{latex}+thesis+)
  \end{block}
...
\begin{frame}[fragile]{Konferenz-Proceedings: \mintinline{latex}+@inproceedings+}
  \begin{block}{Pflichtfelder}
    \texttt{author}, \hspace{2em}
    \texttt{title}, \hspace{2em}
...
\begin{frame}[fragile]{Online-Quellen: \mintinline{latex}+@online+}
  \begin{block}{Pflichtfelder}
    \texttt{title}, \hspace{2em}
...
\begin{frame}[fragile]{Software: \mintinline{latex}+@software+}
  \begin{block}{Pflichtfelder}
    \texttt{title}, \hspace{2em}
    \texttt{year} oder \texttt{date}
  \end{block}
