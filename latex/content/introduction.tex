...
\begin{frame}[fragile]{In diesem Kurs: \LuaTeX}
  \begin{itemize}
    ...
    \item OTF-Fonts
      \begin{itemize}
        \item Alle Fonts benutzen, die man auf dem Rechner hat (nur wenige Fonts wirklich sinnvoll, bitte keine Protokolle in Comic Sans MS)
      \end{itemize}
    \item Unicode-Math
      \begin{itemize}
        \item Mathe-Input über Unicode (bei mir: $\langle$Caps$\rangle\langle$Caps$\rangle$a → $α$)
          \begin{itemize}
