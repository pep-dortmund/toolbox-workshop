...
\begin{frame}[fragile]{\texttt{\textbackslash OverfullCenter}}
  \begin{lstlisting}
    \includegraphics[height=1cm,width=\textwidth+25pt]{logos/tu.pdf}
  \end{lstlisting}

  \vspace{5pt}
  \rlap{\includegraphics[height=1cm,width=\textwidth+25pt]{logos/tu.pdf}}
  ...
  \vspace{5pt}
  \begin{lstlisting}
    \OverfullCenter{\includegraphics[height=1cm,width=\textwidth+25pt]{logos/tu.pdf}}
  \end{lstlisting}
