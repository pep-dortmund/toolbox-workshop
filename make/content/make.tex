...
\begin{frame}[fragile]{Advanced}
  ...
  \begin{itemize}
    ...
    \item Targets von \texttt{.PHONY} existieren nach dem ausführen nicht, keine Dateien/Ordner (guter Stil)
    % vorher: \item Targets, die bei \texttt{.PHONY} genannt werden, entsprechen nicht Dateien (guter Stil)
    % ähnlich dazu: \item Targets, die bei \texttt{.PHONY} genannt werden, sind keine Dateien (guter Stil)
  \end{itemize}
\end{frame}
